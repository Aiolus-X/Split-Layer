...
if args.full_dataset:
    min_id, max_id = 0, 15  # Kodak dataset runs from kodim01.png to kodim24.png
else:
...
for i in range(min_id, max_id + 1):
    ...
    # Load image
    img = imageio.imread(f"../natural/{str(i).zfill(2)}.png")
    #img = imageio.imread(f"/data0/caizc/kodak-dataset/kodim{str(i).zfill(2)}.png")
    ...
    func_rep = Finer(
            ...
            first_omega_0=30, 
            hidden_omega_0=30, 
            first_bias_scale=args.first_bias_scale, 
            scale_req_grad=args.scale_req_grad)
    print(func_rep)
    # Set up training
